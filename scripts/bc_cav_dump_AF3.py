...
# From AF3
# base_dir = "/mnt/data2/Justice/AF3_files/AF3_out/AF3_OR_tmaligned/"
# pdb_files = [os.path.join(base_dir, sub_dir, file) for sub_dir in os.listdir(base_dir) for file in os.listdir(os.path.join(base_dir, sub_dir)) if 'tmalign' in file] 

# From AF3 mouseOR_golf_pdb
# base_dir = "/mnt/data2/Justice/AF3_files/AF3_out/mouseOR_golf_pdb/"
# pdb_files = [os.path.join(base_dir, _file) for _file in os.listdir(base_dir)]

# From AF3 human_golf_pdb
base_dir = "/mnt/data2/Justice/AF3_files/AF3_out/humanOR_golf_pdb/"
pdb_files = [os.path.join(base_dir, _file) for _file in os.listdir(base_dir)]
...
# Save dict as pkl 
import pickle 
with open('/mnt/data2/Justice/OR_learning/files/binding_cavity/human/AF3_dict_bc_pyKVcav_tmaligned.pkl', 'wb') as f:
    pickle.dump(bc_cav_coords, f)
with open('/mnt/data2/Justice/OR_learning/files/binding_cavity/human/AF3_dict_bc_pyKVcavsurf_tmaligned.pkl', 'wb') as f:
    pickle.dump(bc_cavsurf_coords, f)
with open('/mnt/data2/Justice/OR_learning/files/binding_cavity/human/AF3_dict_bc_pyKVres_tmaligned.pkl', 'wb') as f:
